import { redo, undo, type MapRuntimeState } from "@mapdesigner/map-core";
  ...
  return (
    <header className="topbar">
      <div className="brand">
        ...
        <span>{props.mapDirty ? "未保存修改" : "已保存"}</span>
      </div>
      <div className="toolbar">
        ...
        <button onClick={props.onSaveMap} disabled={!props.mapDirty}>
          保存
        </button>
        ...
        <button onClick={props.onDeleteMap} disabled={!props.currentMap}>
          删除地图
        </button>
